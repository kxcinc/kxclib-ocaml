  ...
  let max_fi_float = (2.0 ** 52.0) -. 1.0 in
   [
    "json_unparse_jcsnafi", [
      ...
      case (`num 0.) {|0|};
      case (`num (+0.)) {|0|};
      case_exn (`num (Float.pred min_fi_float)) (Invalid_argument "Number cannot be safely encoded with Json_JCSnafi (encountering: -4503599627370497.000000)");
      case_exn (`num (Float.succ max_fi_float)) (Invalid_argument "Number cannot be safely encoded with Json_JCSnafi (encountering: 4503599627370495.500000)");
