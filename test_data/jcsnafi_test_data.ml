...
module type succ_pred = sig
  val succ : float -> float
  val pred : float -> float
end

let cases_for_unparse_jcsnafi ((module SP) : (module succ_pred)) case case_exn =
  [ (* literal case *)
    case (`null) {|null|};
    case (`bool true) {|true|};
...
let cases_for_is_encodable ((module SP) : (module succ_pred)) case =
  [ (* literal case *)
    case (`null) true;
    case (`bool true) true;
...
let cases_for_is_encodable_num ((module SP) : (module succ_pred)) case =
