...
external _fastpng_libpng_write_rgba : string -> pixel32_buffer -> unit = "fastpng_libpng_write_rgba"
...
let write_png_rgba : filename:string -> pixel32_buffer -> unit =
  fun ~filename ba ->
  _fastpng_libpng_write_rgba filename ba
